<script lang="ts">
	import '../../assets/css/ventanaD.css';
	let rechazados = [
		{
    ...
    let apunta = 'denegado';
	let newvo = rechazados.filter((objeto) => objeto.estado === apunta);
</script>

<section id="denegar">
	<div class="superior2">
		<div id="titulo2">
			<a href="/espera"><h3>espera</h3></a>
		</div>
		<div />
		<div id="titulo2">
			<a href="/confirmados"><h3>confirmados</h3></a>
		</div>
		<div />
		<div id="titulo-denegados2">
	...
	{#each newvo as cat}
		<div id="carta2">
			...
			<h6>{cat.studentName+" | "+ cat.title+" | "+cat.tipo}</h6>
		</div>
	{/each}
</section>
